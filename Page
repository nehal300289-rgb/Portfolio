...
<nav>
  <a href="#" className="nav-logo">Nehal <em>Gadhavi</em></a>
...
<main>
  ...
  {/* HERO */}
  <section className="hero section-wrap" id="hero-section">
    <div>
      <p className="hero-eyebrow">Portfolio · 2026</p>
      <h1 className="hero-name">Nehal<br><em>Gadhavi</em></h1>
      <p className="hero-sub">Data Analyst & AI enthusiast bridging statistical thinking with product strategy. Currently building at SAIT Calgary.</p>
      <div className="contact-row">
        <span className="contact-pill">📍 Calgary, AB</span>
        <a className="contact-pill" href="tel:+18259451120">📞 +1 (825) 945 1120</a>
        <a className="contact-pill" href="mailto:nehal982003@gmail.com">✉️ nehal982003@gmail.com</a>
        <a className="contact-pill" href="https://www.linkedin.com/in/nehal-gadhavi-a03ba12a6/" target="_blank">🔗 LinkedIn</a>
        <a className="contact-pill" href="https://github.com/nehal300289-rgb" target="_blank">🐙 GitHub</a>
      </div>
    </div>
    <div className="avatar-wrap">
      <div className="avatar">NG</div>
      <div className="status-badge"><span className="status-dot"></span> Open to work</div>
    </div>
  </section>

  <section className="section section-wrap" id="about">
    <p className="section-label">About</p>
    <p className="summary-text">Entry-level Data Analyst and AI enthusiast with a Bachelor of Commerce (Statistics) and two postgraduate certificates — Product Management and Integrated Artificial Intelligence (SAIT, exp. Aug 2026). Experienced in building end-to-end machine learning pipelines, conducting primary research and statistical analysis on real-world datasets, and translating technical findings into actionable insights. Seeking a role in data analysis, AI, or AI product management where I can bridge analytical thinking and business strategy.</p>
  </section>
  ...
  <section className="section section-wrap" id="activity">
    <p className="section-label">Live GitHub Activity</p>
    <div className="gh-header">
      <span className="gh-username">Pulling from <a href="https://github.com/nehal300289-rgb" target="_blank">@nehal300289-rgb</a></span>
      <span className="status-badge"><span className="status-dot"></span> Live</span>
    </div>
    <div id="gh-feed"><div className="gh-empty">⏳ Loading activity…</div></div>
  </section>
...
<footer>
  ...
  <span>Calgary, AB · nehal982003@gmail.com · 2026</span>
</footer>
    </>
  );
}
